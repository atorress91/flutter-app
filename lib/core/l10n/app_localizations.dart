...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'forgotPasswordDescription': 'Enter your email address and we will send you a recovery link to reset your password.',
      'emailLabel': 'Email',
      'emailRequired': 'Please enter your email',
      'emailInvalid': 'Please enter a valid email address',
      'sendLinkButton': 'Send Link',
      'forgotPasswordError': 'Could not send the link. Please try again.',
      'forgotPasswordSuccessTitle': 'Link Sent!',
      'forgotPasswordSuccessMessage': 'We have sent a recovery link to your email. Please check your inbox.',
      'okButton': 'OK',
    ...
    'es': {
      ...
      'forgotPasswordDescription': 'Ingresa tu dirección de correo electrónico y te enviaremos un enlace de recuperación para restablecer tu contraseña.',
      'emailLabel': 'Correo electrónico',
      'emailRequired': 'Por favor ingresa tu correo electrónico',
      'emailInvalid': 'Por favor ingresa una dirección de correo electrónico válida',
      'sendLinkButton': 'Enviar enlace',
      'forgotPasswordError': 'No se pudo enviar el enlace. Por favor inténtalo de nuevo.',
      'forgotPasswordSuccessTitle': '¡Enlace enviado!',
      'forgotPasswordSuccessMessage': 'Hemos enviado un enlace de recuperación a tu correo electrónico. Por favor revisa tu bandeja de entrada.',
      'okButton': 'OK',
      'loginOrContinueWith': 'o continúa con',
      'noAccountQuestion': '¿No tienes una cuenta? ',
      'createAccount': 'Crear cuenta',
      'invalidCredentials': 'Usuario o contraseña inválidos.',
      'signInWithBiometrics': 'Iniciar sesión con huella dactilar',
      'enableBiometricsTitle': '¿Habilitar inicio de sesión biométrico?',
      'enableBiometricsContent':
          '¿Te gustaría usar tu huella dactilar para inicios de sesión más rápidos la próxima vez?',
