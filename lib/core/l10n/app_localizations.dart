...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'forgotPasswordDescription': 'Enter your email address and we will send you a security code to reset your password.',
      'emailLabel': 'Email',
      'emailRequired': 'Please enter your email',
      'emailInvalid': 'Please enter a valid email address',
      'sendCodeButton': 'Send Code',
      'forgotPasswordError': 'Could not send the code. Please try again.',
      'forgotPasswordSuccessTitle': 'Code Sent!',
      'forgotPasswordSuccessMessage': 'We have sent a security code to your email. Please check your inbox.',
      'okButton': 'OK',
    ...
    'es': {
      ...
      'forgotPasswordDescription': 'Ingresa tu dirección de correo electrónico y te enviaremos un código de seguridad para restablecer tu contraseña.',
      'emailLabel': 'Correo electrónico',
      'emailRequired': 'Por favor ingresa tu correo electrónico',
      'emailInvalid': 'Por favor ingresa una dirección de correo electrónico válida',
      'sendCodeButton': 'Enviar código',
      'forgotPasswordError': 'No se pudo enviar el código. Por favor inténtalo de nuevo.',
      'forgotPasswordSuccessTitle': '¡Código enviado!',
      'forgotPasswordSuccessMessage': 'Hemos enviado un código de seguridad a tu correo electrónico. Por favor revisa tu bandeja de entrada.',
      'okButton': 'OK',
